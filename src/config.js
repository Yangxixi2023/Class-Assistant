...
export const config = Object.freeze({
  ...
  openaiModel: process.env.OPENAI_MODEL || 'claude-sonnet-4-6',
  openaiModelFast: process.env.OPENAI_MODEL_FAST || process.env.OPENAI_MODEL || 'claude-sonnet-4-6',
  openaiModelDeep: process.env.OPENAI_MODEL_DEEP || process.env.OPENAI_MODEL || 'claude-sonnet-4-6',
  translateApiKey: process.env.TRANSLATE_API_KEY || 'sk-68a13eb63b9e406287e55930745e8a0b',
  translateBaseUrl: process.env.TRANSLATE_BASE_URL || 'https://api.deepseek.com',
  translateModel: process.env.TRANSLATE_MODEL || 'deepseek-v4-flash',
