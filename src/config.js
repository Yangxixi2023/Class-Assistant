...
export const config = Object.freeze({
  ...
  openaiModel: process.env.OPENAI_MODEL || 'claude-sonnet-4-5-20250929',
  openaiModelFast: process.env.OPENAI_MODEL_FAST || process.env.OPENAI_MODEL || 'claude-sonnet-4-5-20250929',
  openaiModelDeep: process.env.OPENAI_MODEL_DEEP || process.env.OPENAI_MODEL || 'claude-sonnet-4-5-20250929',
